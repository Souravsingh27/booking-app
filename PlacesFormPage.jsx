    ...
    return (
        <div>
                    ...
                    <form onSubmit={savePlace}>
                        {preInput('Title ','title for your palce, should be short and catchy as in the advertisement')}
                        ...
                        {preInput('Perks','select all the perks of the palces')}
                        ...
                        {preInput('Check in&out times','check in and out times, remember to have some time for cleaning the room between guests.')}
